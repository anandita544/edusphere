...
function InstructorDashboard() {
  ...
  return (
    <div className=" relative">
      {loading ? (
        <div className=" absolute mt-[28%] left-[50%] -translate-x-[50%]">
          <Spinner />
        </div>
      ) : (
        <div className="text-white flex flex-col pb-10 px-14">
          <div className="w-[80%] flex flex-col gap-2 mb-6">
            <p className="text-richblack-5 text-3xl font-semibold leading-10">
              Hi {user.firstName}
            </p>
            <p className="text-richblack-400 text-lg font-semibold leading-10">
          ...
          <div className=" flex gap-4 mb-4">
            <div className=" w-[75%] bg-richblack-800 p-5 rounded-xl">
              {totalAmount > 0 || totalStudents > 0 ? (
                ...
                <div>
                  <p className="text-richblack-5 text-xl font-semibold leading-10">
                    Visulaize
                  </p>
                  <p className="text-richblack-5 text-lg font-semibold leading-10">
