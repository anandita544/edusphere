    ...
    <div>
      {loading ? (
        ...
        <div className="text-white flex gap-6 pb-32 px-14">
          <div className="w-[85%]">
            <h1 className="text-richblack-5 text-3xl font-semibold leading-10 mb-8">
              Edit Course
            </h1>
          ...
          {course ? (
            <div className=" p-6 rounded-lg border-[1px] border-richblack-700 bg-richblack-800 flex flex-col gap-6 items-start h-fit aspect-square">
              <p className=" flex place-items-center  font-boldest font-inter leading-6 text-richblack-5 gap-1">
