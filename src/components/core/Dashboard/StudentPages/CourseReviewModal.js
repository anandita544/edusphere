      ...
      <div className="w-11/12 max-w-[550px] text-richblack-5 bg-richblack-800 rounded-lg">
        <div className=" flex flex-col gap-3">
          <div className=" flex justify-between items-center bg-richblack-900 p-4 rounded-t-lg">
            <p>Add Review</p>
            <p
              className=" cursor-pointer hover:text-pink-300 duration-200"
          ...
          <div className=" flex gap-2 justify-center items-center">
            <div>
              <img
                src={user.image}
                alt={user.firstName}
                className=" rounded-full object-cover w-[50px] aspect-square h-[50px]"
              />
            </div>
            <div>
          ...
          >
            ...
            <label className=" relative">
              <p className=" form-field-title">
                Add Your Experience <SupStar />
              </p>
              <textarea
                placeholder="Add Your Experience"
                id="courseExperience"
                {...register("courseExperience", { required: true })}
                className=" form-field min-h-[80px] w-full"
              />
